...
function positionClick(rowIndex, columnIndex, event) {
    ...
    if (winner) {
        ...
        if (typeof winner !== "string") {
            ...
            throw "Expecting 'checkWinner' to return a string. Actually received: " + winner;
        }
...
function submitClick(event) {
    ...
    document.getElementById("p1Name").remove();
    document.getElementById("p2Name").remove();
    document.getElementById("p1NameLabel").remove();
    document.getElementById("p2NameLabel").remove();
...
// Bind the click event for the submit button.
